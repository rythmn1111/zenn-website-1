...
function CustomAudioPlayer({ src }: { src: string }) {
  ...
  return (
    <div className="w-full max-w-2xl bg-[#0f1b33] border border-blue-400/30 flex items-center px-4 py-3 gap-3 overflow-hidden">
      <button
        onClick={togglePlay}
      ...
      <span className="text-base text-blue-200 font-mono flex-shrink-0 font-semibold">
...
export default function VerifiableWallet() {
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        {/* Title Page */}
        <div className="text-center mb-16 pb-16 border-b border-blue-400/30">
          <h1 className="text-5xl font-bold text-white mb-4 tracking-tight" style={{ textShadow: '0 0 10px rgba(103,232,249,0.3)' }}>
            Verifiable Hardware Wallet
          </h1>
          <p className="text-xl text-blue-200 mb-2">Open Hardware Schematic</p>
          <p className="text-lg text-blue-300/70">Author: Rythmn Magnani(Hope)</p>
          <p className="text-sm text-blue-400/50 mt-8">Draft 1.0</p>
        </div>
        ...
        <section id="abstract" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>Abstract</h2>
          <div className="bg-[#0f1b33] border-l-4 border-cyan-400 pl-6 py-4 mb-6">
        ...
        <section id="introduction" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>I. Introduction: The Problem</h2>
          ...
          <div id="the-trust-problem" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">I.A. The Trust Problem</h3>
            ...
            <ul className="space-y-3 mb-6 ml-4">
              <li className="text-lg text-blue-100 flex items-start gap-3">
          ...
          <div id="why-verify" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">I.B. Why {"\""}Just Trust Us{"\""} Is Not Enough</h3>
            ...
            <div className="bg-[#0f1b33] border border-blue-400/20 p-6 mb-6 font-mono text-sm">
          ...
          <div id="a-different-approach" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">I.C. A Different Approach</h3>
            ...
            <div className="bg-[#0f1b33] border-l-4 border-cyan-400 pl-6 py-4 mb-6">
              <p className="text-cyan-300 text-xl font-semibold leading-relaxed">
        ...
        <section id="section-ii" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>II. Terminologies</h2>
          ...
          <div id="secure-boot" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">II.A. Secure Boot</h3>
            <p className="text-lg text-blue-100 mb-4">
            ...
            <p className="text-lg text-blue-200 font-semibold mb-3">Without Secure Boot, someone could:</p>
            ...
            <p className="text-lg text-blue-200 font-semibold mb-3">With Secure Boot enabled:</p>
            <ul className="space-y-2 mb-6 ml-4">
              <li className="text-lg text-blue-100 flex items-start gap-3">
                <span className="text-cyan-400 mt-1.5 flex-shrink-0">&#9656;</span>
          ...
          <div id="flash-encryption" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">II.B. Flash Encryption</h3>
            <p className="text-lg text-blue-100 mb-4">
            ...
            <p className="text-lg text-blue-200 font-semibold mb-3">Without Flash Encryption:</p>
            <ul className="space-y-2 mb-6 ml-4">
              <li className="text-lg text-blue-100 flex items-start gap-3">
                <span className="text-cyan-400 mt-1.5 flex-shrink-0">&#9656;</span>
            ...
            <p className="text-lg text-blue-200 font-semibold mb-3">With Flash Encryption:</p>
            <ul className="space-y-2 mb-6 ml-4">
              <li className="text-lg text-blue-100 flex items-start gap-3">
                <span className="text-cyan-400 mt-1.5 flex-shrink-0">&#9656;</span>
          ...
          <div id="efuse-burn" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">II.C. eFuse Burn</h3>
            <p className="text-lg text-blue-100 mb-4">
            ...
            <p className="text-lg text-blue-200 font-semibold mb-3">eFuses are used for:</p>
            <ul className="space-y-2 mb-6 ml-4">
              <li className="text-lg text-blue-100 flex items-start gap-3">
                <span className="text-cyan-400 mt-1.5 flex-shrink-0">&#9656;</span>
        ...
        <section id="section-iii" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>III. Components Overview</h2>
          <p className="text-lg text-blue-100 mb-8">
          ...
          <div id="hardware-arch" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">III.A. Hardware Architecture</h3>
            <p className="text-lg text-blue-100 mb-4">
              The wallet uses two ESP32-S3 chips:
            </p>
            <div className="bg-[#0f1b33] border border-blue-400/20 p-6 mb-6">
              <p className="text-cyan-300 font-semibold text-lg mb-3">Vault ESP32-S3 (Security Domain)</p>
              ...
              <p className="text-cyan-300 font-semibold text-lg mb-3">Interface ESP32-S3 (UI/IO Domain)</p>
          ...
          <div id="web-verification" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">III.B. Web Verification Client</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="firmware-registry" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">III.C. AO Firmware Registry</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="device-registry" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">III.D. AO Device Registration Registry</h3>
            <p className="text-lg text-blue-100 mb-4">
        ...
        <section id="section-iv" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>IV. Step 1: Firmware Verification</h2>
          <p className="text-lg text-blue-100 mb-6">
          ...
          <div id="starting-state" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">IV.A. Starting Device State</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="verification-mechanism" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">IV.B. Verification Mechanism</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="trust-minimized" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">IV.C. Trust-Minimized Option</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="secure-boot-matters" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">IV.D. Why Secure Boot Matters Here</h3>
            <p className="text-lg text-blue-100 mb-4">
        ...
        <section id="section-v" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>V. Step 2: Device Registration</h2>
          <p className="text-lg text-blue-100 mb-6">
          ...
          <div id="no-preinstall" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">V.A. Why Identity Is Not Pre-Installed</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="registration-challenge" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">V.B. Registration Challenge</h3>
            <p className="text-lg text-blue-100 mb-4">
              The website generates a one-time registration challenge (QR):
            </p>
            <pre className="bg-[#0a1628] text-blue-200 p-4 rounded-lg overflow-x-auto mb-6 border border-blue-400/20">
              <code>{`{
  ...
  firmware_hash: <hash of firmware verified in Step 1>
          ...
          <div id="identity-creation" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">V.C. Identity Creation and Signature</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="registration-proof" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">V.D. Registration Proof and AO Record</h3>
            <p className="text-lg text-blue-100 mb-4">
  ...
  registered_at
          ...
          <div id="anti-replay" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">V.E. Why Replay Does Not Work</h3>
            <p className="text-lg text-blue-100">
        ...
        <section id="section-vi" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>VI. Step 3: Locking the Device</h2>
          <p className="text-lg text-blue-100 mb-6">
          ...
          <div id="locking-mechanism" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">VI.A. Locking Mechanism</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="delayed-encryption" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">VI.B. Why Flash Encryption Is Delayed</h3>
            <p className="text-lg text-blue-100 mb-4">
        ...
        <section id="section-vii" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>VII. Operational Verification</h2>
          <p className="text-lg text-blue-100 mb-6">
          ...
          <div id="fresh-challenge" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">VII.A. Fresh Challenge-Response</h3>
            <p className="text-lg text-blue-100 mb-4">
          ...
          <div id="replay-fail" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">VII.B. Why Replay Devices Fail</h3>
            <p className="text-lg text-blue-100 mb-6">
          ...
          <div id="why-verifiable" className="mb-8">
            <h3 className="text-2xl font-semibold text-blue-200 mb-4">VII.C. Why This Is {"\""}Verifiable{"\""} Compared to Typical Wallets</h3>
            <p className="text-lg text-blue-100 mb-4">
        ...
        <section id="section-viii" className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6" style={{ textShadow: '0 0 8px rgba(103,232,249,0.2)' }}>VIII. Build Your Own</h2>
          <p className="text-lg text-blue-100 mb-6">
          ...
          <div className="bg-[#0f1b33] border border-blue-400/20 p-8 text-center">
            <a
              href="https://github.com/rythmn1111/verifiable_wallet"
              target="_blank"
              rel="noopener noreferrer"
              className="text-cyan-300 text-2xl font-bold hover:text-white transition-colors"
